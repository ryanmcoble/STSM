...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ secure_asset('assets/css/bootstrap.min.css') }}" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous">
        
        <link rel="stylesheet" href="{{ secure_asset('assets/css/font-awesome.min.css') }}">
        <link rel="stylesheet" href="{{ secure_asset('assets/css/jquery-simplecolorpicker.css') }}">
